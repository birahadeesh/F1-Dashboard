...
def create_app(config_class=Config):
    ...
    def dashboard():
        ...
        favorites = []
        if current_user.is_authenticated:
            favorites = [fav.race_id for fav in FavoriteRace.query.filter_by(user_id=current_user.id).all()]
    ...
    def race_details(race_id):
        ...
        race_folder = os.path.join(app.config['RACES_FOLDER'], race.folder_name)
